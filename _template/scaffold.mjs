...
// comment block documenting them. useAuthStore/$onAction stay matched so a slice generated by an older
// template still strips cleanly. Case-insensitive: the marker reads "No-auth app:" when it opens a
// sentence, and a case-sensitive test silently left the whole comment behind.
const authLine = /onAuthenticated|useAuthStore|authStore\.\$onAction|no-auth app:/i
