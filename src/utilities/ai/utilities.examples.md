...
`fileUtility.saveAs`) or **granular subpaths** (`@regira/modules/utilities/array-utility`). The demo apps
...
```ts
import { groupBy, orderBy } from "@regira/modules/utilities/array-utility"
...
```ts
import { isEmail, isDate, isPhone, isUrl } from "@regira/modules/utilities/string-utility"
...
```ts
import { saveAs } from "@regira/modules/utilities/file-utility"
...
```ts
import { arrayUtility, stringUtility } from "@regira/modules/utilities"
